...
seoMeta:
  ...
  ogDescription: "六週實作課程，從 Git 版本控制、GitHub 協作與 GitHub Actions CI/CD，一路走到 Docker 部署、通知系統與 AI 協作。從這裡掌握課程設計、技能樹 Dashboard 與每週重點。"
...
---
layout: data-01
heading: 兩大產物——六週帶走兩個上線的作品
cols:
  - label: W1–W3/
    heading: 技能樹 Dashboard
    desc: 前半段聚焦版本控制與作品維護，把學習進度整理成一個可持續更新的上線成果。
    active: true
  - label: W4–W6/
    heading: CI/CD 部署通知系統
    desc: 後半段聚焦協作、自動化與部署，把開發流程串成一條可以重複執行的交付管線。
    active: true
---

---
layout: image-01
slug: product/skill-tree-dashboard
heading: 技能樹 Dashboard——第一個上線作品
body: 第一週會從模板建立自己的版本，部署到 GitHub Pages 公開上線。之後每學會一個知識點，就在技能樹上點亮一格；未來第二、三週的分支、衝突與救援技巧，也會直接用在這個作品上。
...
cols:
  - label: before/
    heading: Gemini CLI
    desc: 原課綱採用的 AI 命令列工具，已於 2026 年 6 月 18 日起停止服務免費與 AI Pro / Ultra 使用者的請求。
    icon: /gemini-cli.png
  - label: after/
    heading: Antigravity CLI
    desc: 課程改以 Antigravity CLI 作為 AI 副駕主力，保留原本的命令列協作精神，也補上更完整的工作流示範。
    active: true
...
body: 接著進入第一週簡報，先理解版本控制為什麼重要，再建立自己的技能樹 Dashboard，並在今天結束前把它公開上線。
---
